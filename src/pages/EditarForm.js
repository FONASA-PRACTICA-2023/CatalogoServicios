...
import { buscarVectorPorId, addPhoto } from "./servicios";
...
const EditarForm = () => {
  ...
  const loadVector = async () => {
    try {
      ...
      setCasoDiasEstab(vector.datosVector.v21_grave_fio2);
      setCasoGraveFIO2(vector.datosVector.v22_dias_estab);
  ...
  return (
    <Layout title="" subtitle="Editar caso clínico">
          ...
          <Col>
            <Form>
              ...
              <Form.Row className="text-left">
                ...
                <Form.Group as={Col} controlId="formGridTriage">
                  ...
                  <Form.Check
                    ...
                    id="triage_sinValor"
                    value="NA"
                    checked={casoTriage === "NA" ? true : false}
              ...
              <Form.Row className="text-left dl-horizontal ">
                <Form.Group as={Col}>
                  <Form.Label>Presion Sistolica Alta</Form.Label>
                  <InputGroup>
                    <Form.Control
                      readOnly
                      type="number"
              ...
              <Form.Row className="text-left dl-horizontal ">
                <Form.Group as={Col}>
                  <Form.Label>Presion Sistolica Baja</Form.Label>
                  <InputGroup>
                    <Form.Control
                      readOnly
                      type="number"
              ...
              <Form.Row className="text-left dl-horizontal ">
                <Form.Group as={Col} className="col-md-4">
                  <Form.Label>Presion Sistolica Media</Form.Label>
                  <InputGroup>
                    <Form.Control
                      readOnly
                      type="number"
              ...
              <Form.Row className="text-left dl-horizontal ">
                ...
                <Form.Group as={Col}>
                  ...
                  <Form.Control
                    as="select"
                    value={casoTipoCama}
                    onChange={this.setTipoCama}
                  >
                    <option selected value={casoTipoCama}>
                      {casoTipoCama}
                    </option>
                    {constantes.optionsTipoCama.map((option) => (
                ...
                <Form.Group as={Col}>
                  ...
                  <Form.Control
                    as="select"
                    value={casoSubtipoCama}
                    onChange={this.setSubtipoCama}
                  >
                    <option selected value={casoSubtipoCama}>
                      {casoSubtipoCama}
                    </option>
                    {constantes.optionsSubTipoCama.map((option) => (
                      <option value={option.value}>{option.label}</option>
                    ))}
                  </Form.Control>
                </Form.Group>
              ...
              <Form.Row className="text-left">
                <Form.Group as={Col}>
                  ...
                  <Form.Control
                    as="select"
                    value={casoGlasgow}
                    onChange={this.setGlasgow}
                  >
                    <option selected value={casoGlasgow}>
                      {casoGlasgow}
                    </option>
                    {constantes.optionsGlasgow.map((option) => (
                      <option value={option.value}>{option.label}</option>
                    ))}
                  </Form.Control>
                </Form.Group>
              ...
              <Form.Row className="text-left">
                ...
                <Form.Group as={Col}>
                  <Form.Label>Cirugua Realizada</Form.Label>
                  <Form.Check
                    type="radio"
                    label="(sin valor)"
                    name="cirugia"
                ...
                <Form.Group as={Col}>
                  <Form.Label>Cirugua Realizada Mismo dia</Form.Label>
                  <Form.Check
                    type="radio"
                    label="(sin valor)"
                    name="cirugiaMD"
              ...
              <Form.Row className="text-left dl-horizontal">
                <Form.Group as={Col} className="col-md-6">
                  ...
                  <Form.Control
                    as="select"
                    value={casoPrestador}
                    onChange={this.setPrestador}
                  >
                    <option selected value={casoPrestador}>
                      {casoPrestador}
                    </option>
                    {constantes.optionsPrestador.map((option) => (
                      <option value={option.value}>{option.label}</option>
                    ))}
                  </Form.Control>
                </Form.Group>
