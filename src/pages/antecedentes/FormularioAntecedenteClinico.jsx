        ...
        <div className="col-12 mb-3">
          ...
          >
            ...
            <div className="col-md-4">
              ...
              >
                <option value="">Seleccionar...</option>
                {optionsTipoPaciente.map((option) => (
                  <option value={option.value} key={option.value}>
                    {option.label}
                  </option>
                ))}
            ...
            <div className="col-md-4">
              <label className="form-label">
                Fio2<span className="text-danger fw-bold fs-5">*</span>
              </label>
              <div className="input-group mb-3">
                <input
                  required
            ...
            {/* V21_GRAVE_FIO2 */}
            <div className="col-md-4">
              <label className="form-label">O {">"} 50% FIO2 (v20)</label>
              ...
              <div className="form-check">
                <input
                  ...
                  disabled={
                    ...
                    valoresFormulario.v25_cirugia_realizada === "NO"
                  }
                  type="radio"
            ...
            {/* V28_HEMODINA_MISMO_DIA_INGRESO */}
            <div className="col-md-2">
              <label className="form-label">Hemodinamia día ingreso</label>
              ...
              <div className="form-check">
                <input
                  ...
                  disabled={
                    formularioDesahabilitado ||
                    valoresFormulario.v27_hemodinamia_realizada === "NO"
                  }
                  type="radio"
            ...
            {/* V30_ENDOSCOP_MISMO_DIA_INGRESO */}
            <div className="col-md-2">
              <label className="form-label">Endoscopia día ingreso</label>
              ...
              <div className="form-check">
                <input
                  ...
                  disabled={
                    formularioDesahabilitado ||
                    valoresFormulario.v29_endoscopia === "NO"
                  }
                  type="radio"
            ...
            {/* V36_TROMBOLI_MISMO_DIA_INGRESO */}
            <div className="col-md-2">
              <label className="form-label">Trombólisis día ingreso</label>
              ...
              <div className="form-check">
                <input
                  ...
                  disabled={
                    formularioDesahabilitado ||
                    valoresFormulario.v35_trombolisis === "NO"
                  }
                  type="radio"
            ...
            {/* V50_RNM_PROTOCOLO_STROKE */}
            <div className="col-md-2">
              <label className="form-label">Protocolo Stroke de RNM</label>
            ...
            <div className="col-md-3">
              <label className="form-label">PCR (Proteína C Reactiva)</label>
              <div className="input-group mb-3">
                <input
                  className="form-control"
                  name="v40_pcr"
