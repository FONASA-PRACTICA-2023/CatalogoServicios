...
function FormularioServicioIntegracion() {
    ...
    const getData = () => {
        ...
        fetch(`https://o5t896hzxk.execute-api.us-east-1.amazonaws.com/Prod/servicio/${nombre}`, requestOptions)
                ...
                <form onSubmit={handleSubmit}>
                    <div className="row">
                        ...
                        <div className="col-md-10">
                            ...
                            <input type="text" disabled={formularioDeshabilitado} className="form-control" id="nombre" name="nombre" value={formulario.nombre} onChange={handleChange} required />
                        ...
                        <div className="col-md-2">
                            ...
                            <input type="text" className="form-control" disabled={formularioDeshabilitado} id="autor_id" value={formulario.autor_id} name="autor_id" required />
                            <div className="invalid-feedback">Debe ingresar un valor</div>
                        </div>
                    </div>
                    ...
                    <div className="col-md-12">
                        ...
                        <textarea className="form-control" disabled={formularioDeshabilitado} rows="3" id="descripcion" name="descripcion" value={formulario.descripcion} onChange={handleChange}></textarea>
                        <div className="invalid-feedback">Debe ingresar un valor</div>
                    </div>
                    <div className="row">
                        {/* TPS_ESTIMADAS */}
                        ...
                        <div className="col-md-4">
                            ...
                            <div className="input-group mb-3">
                                <input className="form-control" disabled={formularioDeshabilitado} value={formulario.promedio_uso_mensual} onChange={handleChange} name="promedio_uso_mensual" id="promedio_uso_mensual" type="number" maxLength="3" min="0" max="10000000" step="1" />
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            ...
                            <textarea className="form-control" rows="3" id="pregunta" name="pregunta" disabled={formularioDeshabilitado} value={formulario.pregunta} onChange={handleChange}></textarea>
                            <div className="invalid-feedback">Debe ingresar un valor</div>
                        </div>
                        {/* RESPONSE */}
                        <div className="col-md-6">
                            ...
                            <textarea className="form-control" rows="3" id="respuesta" name="respuesta" disabled={formularioDeshabilitado} value={formulario.respuesta} onChange={handleChange}></textarea>
                            <div className="invalid-feedback">Debe ingresar un valor</div>
                        </div>
                    </div>
                    <hr className="my-4" />
                    <div className="row">
                        ...
                        <div className="col-md-3">
                            ...
                            {["si", "no"].map((value) => (
                                <div className="form-check" key={value}>
                                    <input className="form-check-input" disabled={formularioDeshabilitado} type="radio" name="habilita_cors" id={`habilita_cors_${value}`} checked={formulario.habilita_cors === value}
                        ...
                        <div className="col-md-3">
                            ...
                            {["si", "no"].map((value) => (
                                <div className="form-check" key={value}>
                                    <input className="form-check-input" disabled={formularioDeshabilitado} type="radio" name="validacion_jwt" id={`validacion_jwt${value}`} checked={formulario.validacion_jwt === value}
                                        onChange={handleChange} value={value} />
                                    <label htmlFor={`habilita_cors_${value}`} className="form-check-label">
                                        {value.charAt(0).toUpperCase() + value.slice(1)}
                                    </label>
                    ...
                    <div className="row">
                            ...
                            {["si", "no"].map((value) => (
                                <div className="form-check" key={value}>
                                    <input className="form-check-input" type="radio" checked={formulario.guarda_log_request_response === value}
                                        onChange={handleChange} disabled={formularioDeshabilitado} name="guarda_log_request_response" id={`guarda_log_request_response_${value}`} value={value} />
                        ...
                        <div className="col-md-3">
                            ...
                            {["si", "no"].map((value) => (
                                <div className="form-check" key={value}>
                                    <input className="form-check-input" disabled={formularioDeshabilitado} type="radio" checked={formulario.genera_alarma_por_incumplimiento_politica === value}
